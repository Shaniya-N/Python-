...
# To simplify, he decided to represent mathematical expressions using words.
# For numbers, he mentions each digit individually with the character 'c' to 
# signify the entire word representing the number. Prabhu exclusively uses lowercase
# letters as he's not proficient with shift keys or caps lock. 
